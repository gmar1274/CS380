...
public class FTP_Server extends JFrame {
	...
	public FTP_Server() {
		...
		final FTP_Server FTP_Server = this;
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (b.getText().contains("Stop Listening")) {
						...
						displayToServer("Sever stopped listening on port: " + server.getServerSocket().getLocalPort() + ".");
						return;
					}
					Thread t = new Thread(new Runnable() {
						public void run() {
							server = new Server(Integer.parseInt(portText.getText()),FTP_Server);
							server.startServer();
						}
					});
					t.start();
	...
	public void displayToServer(String msg) {
